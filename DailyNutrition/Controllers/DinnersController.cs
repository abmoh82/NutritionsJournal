...
namespace DailyNutrition.Controllers
{
    public class DinnersController : Controller
    {
        ...
        public DinnersController(DailyNutritionContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,Date,Portion,Beverage,Volym")] Dinner dinner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description,Date,Portion,Beverage,Volym")] Dinner dinner)
        {
            if (id != dinner.Id)
            {
                return NotFound();

...
namespace DailyNutrition.Controllers
{
    public class SnacksController : Controller
    {
        ...
        public SnacksController(DailyNutritionContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,Date,Portion,Beverage,Volym")] Snacks snacks)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description,Date,Portion,Beverage,Volym")] Snacks snacks)
        {
            if (id != snacks.Id)
            {
                return NotFound();
